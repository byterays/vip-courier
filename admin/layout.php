	...
	<div id="main-wrapper">
        ...
        ***********************************-->
		<div class="nav-header">
			<a href="index.html" class="brand-logo">
				<object data="assets/images/svg/icon-logo.svg" type="image/svg+xml" height="20"></object>
				&nbsp;<object data="assets/images/svg/text-logo.svg" type="image/svg+xml" height="12"></object>
			</a>
		...
		<div class="deznav">
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					<li class="menu-title">VIP COURIER & CARGO</li>
        ...
        ***********************************-->
		<div class="footer out-footer">
			<div class="copyright">
				<p>Copyright © Developed by <a href="//dexignzone.com/" target="_blank">DexignZone</a> 2023</p>
			</div>
		</div>
		<!--**********************************
            Footer end

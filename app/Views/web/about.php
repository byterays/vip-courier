...
<head>
    ...
    <meta property="og:url" content="en/admin/shipments/calculator">
...
@media (max-width: 991px){
   ...
   <nav class="navbar navbar-expand-custom navbar-mainbg">
        ...
        <button class="navbar-toggler" type="button" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
         <svg xmlns="//www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-menu"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg>
        </button>
...
<nav aria-label="primary mobile" class="drawer d-lg-none">
    <header class="header d-lg-none d-flex justify-content-between align-items-center">
      <img src="html/assets/lte/cargo-logo-small-h38.svg" alt="FRAMEWORK" />
    ...
    <div class="body">
      <ul class="nav-list list-unstyled mb-0">
                    <li class="nav-item">
                <a class="nav-link" href="index-2" style="">Home </a>
            </li>
                ...
                <li id="menu-item-1" class="nav-item  menu-item menu-item-type-custom menu-item-object-custom menu-parent-item menu-item--parent bd_menu_item">
                    <a class="nav-link dropdown-item " href="tracking" >Tracking</a></li>
                ...
                <li id="menu-item-3" class="nav-item  menu-item menu-item-type-custom menu-item-object-custom menu-parent-item menu-item--parent bd_menu_item">
                    <a class="nav-link dropdown-item " href="calculator" >Shipment Calculator</a></li>
                ...
                <li id="menu-item-5" class="nav-item  menu-item menu-item-type-custom menu-item-object-custom menu-parent-item menu-item--parent bd_menu_item">
                    <a class="nav-link dropdown-item " href="about-2" >About Us</a></li>
 <li id="menu-item-5" class="nav-item  menu-item menu-item-type-custom menu-item-object-custom menu-parent-item menu-item--parent bd_menu_item">
                    <a class="nav-link dropdown-item " href="contact" >Contact Us</a></li>
      </ul>
    </div>
</nav>
...
<h2 class="about_text">About Our Company</h2>
<p class="about_para">Business applications through revolutionary catalysts for procedures whereas processes.
...
Vip Courier and Cargo Pvt. Ltd. is an AI-Enabled Shipping Platform (SaaS) with decades of knowledge and experience. It is one of the fast-growing tech-enabled logistics companies that offers industry-best pricing with leading shipping partners for all your shipping needs. With Vip Courier and Cargo, you will get multiple shipping partners with comparable rates and much more from a single platform. Vip Courier and Cargo has been using innovative ideas to simplify the eCommerce platform for sellers and save essential time and money. We help sellers to focus on their business rather than finding reliable shipping partners.

Our aim is to provide hassle-free and streamlined shipping solutions to make your market presence a smooth ride. It offers an innovative one-stop shop for all logistics services, right from the automatic allocation of the courier to dispatch to the last mile delivery of packages.
...
Linked by some of the most advanced communications systems and positioned to offer a consistent, premium, standardized quality of service.We are the only express carrier in the country today which offers an entire range of services that extend from a document to a charter-load of shipments. Our services are relentlessly monitored to deliver a net service level of 99.96%.
We have a dedicated team of specialists who provide the expertise for customs as well as regulatory clearances at all States within the country, to support seamless service to the customer.
Designed to enhance the reliability of our operations and process efficiency, and add value to the customer through time and cost savings.The only one of its kind in the country today, that is focused on carriage of packages as its prime business, rather than as a by-product of a passenger airline. A dedicated aviation system to support vip courier and cargo services is self-sustaining, with its own bonded warehouses, ground handling and maintenance capability.Committed, diverse and over 11,000+ strong are our most valued asset. All our achievements have been possible because we have a team who believes in themselves and their company, a team with a winning attitude. We are a learning organization, we value self-development, and most of our managers are homegrown.
</p>
    ...
    <div class="container">
            ...
            <div class="row footer-cols">
                <div class="col-lg-4 col-md-6">
                    <aside id="footer_sidebar_1" class="sidebar-footer"><section class="my-widget"><div class="wpb_widgetised_column">
    ...
    <div class="wpb_widgetised_column">
        <div id="bdaia-widget-counter-2" class="content-only widget bdaia-widget bdaia-widget-counter">
            <div class="widget-box-title widget-box-title-s4"><h3>Stay Connected</h3></div>
               <ul><li class="mn"><i class="fa fa-address-card-o" aria-hidden="true"></i><a href="tel:98714 20063" class="text-white hb">Name - VIP courier & cargo Services</a></li>
        ...
        <li class="mn"><i class="fa fa-envelope-open-o" aria-hidden="true"></i><a href="mailto:info@vipcourierandcargo.com" class="text-white hb"> info@vipcourierandcargo.com</a></li></ul>
            <!-- End Social Counter/-->
        </div>
        <div class="widget content-only"></div>
    </div>
...
<script src="html/easyship/assets/js/main.js"></script>
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.slim.min.js" crossorigin="anonymous"></script>
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.bundle.js"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js"></script>
            <script src="html/assets/global/js/jquery.geocomplete.js"></script>
        <script src="//maps.googleapis.com/maps/api/js?libraries=places&amp;key=AIzaSyBvKvwZV9jGaRG2kcWMfb29gEhhyRrJOek"></script>
        <script>
        ...
        $(".nextStep2_button").click(function(){
            ...
            var email = $("#email").val();
            var type = 'Client';
            $.get("en/user/check-email?type="+type+"&Client[email]="+email+"&calc=true", function(data) {
        ...
        $('#change-country').change(function() {
            var id = $(this).val();
            $.get("en/admin/countries/ajax-get-states?country_id=" + id, function(data) {
        ...
        $('#change-state-from').change(function() {
            var id = $(this).val();
            $.get("en/admin/countries/ajax-get-areas?state_id=" + id, function(data) {
                $('select[name ="Shipment[from_area_id]"]').empty();
                $('select[name ="Shipment[from_area_id]"]').append('<option>Select Area</option>');
                for (let index = 0; index < data.length; index++) {
                    const element = data[index];
                    $('select[name ="Shipment[from_area_id]"]').append('<option value="' + element['id'] + '">' + JSON.parse(element['name'], true)[`en`] + '</option>');
                }
            });
        });
        ...
        $('#change-state-to').change(function() {
            ...
            $.get("en/admin/countries/ajax-get-areas?state_id=" + id, function(data) {
                ...
                for (let index = 0; index < data.length; index++) {
                    const element = data[index];
                    $('select[name ="Shipment[to_area_id]"]').append('<option value="' + element['id'] + '">' + JSON.parse(element['name'], true)[`en`] + '</option>');
                }
            });
        });
        ...
        $(function () {
            ...
            function ajaxShipmentCost()
            {
                ...
                var request_data = { _token : 'Bc4iyDMhvZjJLXs1Q32PgfczTgOl5JnimEgHAAyg',
                ...
                $.post('en/admin/shipments/get-estimation-cost', request_data, function(response){
                    if( 2 =='1'){
            ...
            {
                document.getElementById("shipping_cost").innerHTML = "Calculating...";
                document.getElementById("tax_duty").innerHTML      = "Calculating...";
                document.getElementById("insurance").innerHTML     = "Calculating...";
                document.getElementById("total_cost").innerHTML    = "Calculating...";
            }
            function calc_waiting_meil()
            {
                $('#in_mile').html("Calculating...");
                $('#price').html("Calculating...");
                $('#duration_text').html("Calculating...");
            }
        });
    </script>

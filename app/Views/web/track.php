...
<head>
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/moment.js/2.30.1/moment.min.js" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
                            ...
                            <form class="form" action="track" method="POST">
                                ...
                                <div class="mc4wp-form-fields">
                                    <p>
                                        ...
                                        <input type="text" name="code" value="<?= @$lrn ?>" placeholder="Enter tracking code (lrn)">
                                    </p>
                                    <p>

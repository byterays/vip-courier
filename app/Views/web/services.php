...
<head>
    ...
    <meta property="og:url" content="vip courier and cargo">
...
<body class="home page-template-default page wp-embed-responsive has-lazy-load" itemscope="itemscope" itemtype="https://schema.org/WebPage">
    ...
    <section id="supercharge" class="section" style="">
        <div class="container">
            ...
            <div class="contents">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="info">
                            <h3 class="heading" style="">Never Waste Time on Shipping Again</h3>
                            <p class="sub" style="">
                                One tool to manage and automate all your shipping needs.
                                Compare shipping quotes, generate labels, schedule pickups, and monitor finances through our intuitive cloud-based shipping software. Explore our shipping software.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="wrapper">
                            <img src="html/easyship/assets/images/supercharge-store.webp" alt="demo" class="graphic d-lg-none">
                            <img src="html/storage/33/5.svg" alt="demo" class="graphic d-none d-lg-block">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="myButton">
        <a href="https://wa.me/+918920095642" target="_blank"> <img src="//unitedexpress.in/static/unitedexpress/frontendassets/images/whatsapp.svg" alt="call us on +918920095642
"></a>
    </div>
    <div id="myCall">
...
"><img src="//unitedexpress.in/static/unitedexpress/frontendassets/images/phone.svg" alt="call us"></a>
    ...
    <script src="http://maps.googleapis.com/maps/api/js?libraries=places&amp;key=AIzaSyBvKvwZV9jGaRG2kcWMfb29gEhhyRrJOek"></script>
    <script>

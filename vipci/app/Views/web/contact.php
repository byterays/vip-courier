    ...
    <style type='text/css'>
        ...
        @media only screen and (max-width: 900px) {
            div.bd-push-menu-inner::before {
                background-image: url("html/assets/images/dsfdsfsddfsfd") !important;
        ...
        div.bdaia-footer::before {
            background-image: url("html/assets/images/footer-background") !important;
            background-repeat: no-repeat;
            background-attachment: scroll;
        ...
        .bdaia-header-default .header-container .bd-container {
            background: url("html/assets/images/top-shadow") no-repeat top;
        }
...
*/
        ...
        *::placeholder {
        ...
        .header-3 .main-menu nav>ul>li>a::after {
            background-image: url("img/icon/menu-border");
            background-repeat: no-repeat;
            content: "";
            height: 3px;
            position: absolute;
        ...
        .tag {
            ...
            padding: 2px;
            z-index: 6;
            background: url(img/icon/salebg) no-repeat 0 0;
        }
        ...
        */ .contact-address-area {}
        ...
        .product-tab li a.active::after {
            background-image: url("img/shape/1");
            background-repeat: no-repeat;
            content: "";
            height: 6px;
            position: absolute;
        ...
        .about-shape::before {
            background-image: url("img/about/shape");
            background-repeat: no-repeat;
            content: "";
            height: 260px;
            position: absolute;
        ...
        .features-wrapper::before {
            background-image: url("img/features/11");
            background-repeat: no-repeat;
            content: "";
            height: 100%;
            position: absolute;
        ...
        .section-circle::before {
            background-image: url("img/shape/2");
            background-repeat: no-repeat;
            content: "";
            height: 131px;
            position: absolute;
        ...
        #callme #callmeMain:before {
            ...
            top: 0;
            left: 0;
            background-image: url(img/icon/whatsapp);
            background-repeat: no-repeat;
            background-position: center center;
        ...
        div#shipments-tracking {
            background-color: #1d313f00 !important;
        }
...
<body class="home page-template-default page wp-embed-responsive has-lazy-load" itemscope="itemscope" itemtype="schema.org/WebPage">
        ...
        <header id="main-header" class="active light_style">
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-8 col-md-8">
                            <div class="header-wrapper">
                                <div class="header-text"> <span class="vb"> <i class="fa fa-map-o "></i>F 30/5 okhla
                                        phase 2 opp hdfc bank new delhi 110020</span> <span class="vb"> <i class="fa fa-envelope-open-o"></i> <a href="mailto: info@vipcourierandcargo.com" class="__cf_email__ text-white" data-cfemail=""> info@vipcourierandcargo.com</a></span> </div>
                            </div>
                        </div>
            ...
            <div class="mobile-top mobile-view">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <i class="fa fa-map-o" aria-hidden="true"></i> <a href="#" class="text-white">F 30/5 okhla
                                phase 2 opp hdfc bank new delhi 110020</a>
                        </div>
            ...
            <nav class="navbar navbar-expand-custom navbar-mainbg">
                <a class="navbar-brand navbar-logo" href="#"><img class="my_img" src="html/assets/lte/logo.png" alt="Vip Courier and Cargo" /></a>
    ...
    <nav aria-label="primary mobile" class="drawer d-lg-none">
        ...
        <div class="body">
            <ul class="nav-list list-unstyled mb-0">
                <li class="nav-item">
                    <a class="nav-link" href="index" style="">Home </a>
                </li>
                ...
                <li id="menu-item-3" class="nav-item  menu-item menu-item-type-custom menu-item-object-custom menu-parent-item menu-item--parent bd_menu_item">
                    <a class="nav-link dropdown-item " href="our-services">Shipment Calculator</a>
                </li>
    ...
    <div class="about_us">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="breadcrumb-area pt-40 pb-60" style="background-image:url(html/img/bg/bg15.html)">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-12">
                    ...
                    <div class="contact-area  pb-200">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-8">
                                    <div class="contact-bg2 pt-90 pb-70" style="background-image:url(html/img/bg/bg18.html)">
                                        <div class="row">
                                            <div class="col-xl-12">
                                        ...
                                        <section id="booking-form">
                                            ...
                                            <form action="#" method="POST" name="dataform" id="enqFormId" class="form_grups">
                                                <input type="hidden" name="_token" value="byyWJXyQ8FLyZVyeBVLAtsvdvbCqtqb0bL0buO3T">
                                                <fieldset>
                                                    <ul class="formFields list-unstyled">
                                                        <li class="row">
                                                            <div class="col-md-6">
                                                                <input type="text" class="end-input" name="name" placeholder="Name" required="">
                                                            </div>

                                                            <div class="col-md-6">
                                                                <input type="text" class="end-input" name="phone" placeholder="Phone" required="">
                                                            </div>
                                                        ...
                                                        <li class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input type="text" class="end-input" name="email" placeholder="Email" required="">
                                                            </div>
                                                        </li>
                                                        <li class="row">
                                                        ...
                                                        <li class="row">
                                                            <div class="col-md-12">
                                                                <textarea class="end-textarea" name="cont" placeholder="Query" required=""></textarea>
                                                            </div>
                                                        </li>

                                                        <li class="row">
                                                            <div class="col-md-12 text-center">
                                                                <div class="group-button mt-20">

                                                                    <input type="submit" name="talktous" class="btn btn-success" value="Submit">
                        ...
                        <section class="my-widget">
                            <div class="wpb_widgetised_column">
                                <div class="content-only widget bdaia-widget bdaia-box1">
                                    ...
                                    <p class="pra">Exceed your customer’s expectations with a curated delivery
                                        experience. Keep your customers informed with shipment tracking pages and emails
                                        that match your branding, and customized packing slips for a personal touch.
                                        Learn how to brand your delivery experience.</p>
                            ...
                            <section class="social-counters-widget">
                                <div class="wpb_widgetised_column">
                                    <div id="bdaia-widget-counter-2" class="content-only widget bdaia-widget bdaia-widget-counter">
                                        ...
                                        <ul>
                                            <li class="mn"><i class="fa fa-address-card-o" aria-hidden="true"></i><a href="tel:98714 20063" class="text-white hb">Name - VIP courier &
                                                    cargo Services</a></li>
                                            ...
                                            <li class="mn"><i class="fa fa-envelope-open-o" aria-hidden="true"></i><a href="mailto:info@vipcourierandcargo.com" class="text-white hb">
                                                    info@vipcourierandcargo.com</a></li>
                                        </ul>
                                        <!-- End Social Counter/-->
                                    </div>
                                    <div class="widget content-only"></div>
    ...
    <div id="myButton">
        <a href="wa.me/+918920095642" target="_blank">
            <img src="//unitedexpress.in/static/unitedexpress/frontendassets/images/whatsapp.svg" alt="call us on +918920095642">
        </a>
    </div>
    <div id="myCall">
    ...
    <script>
        ...
        $(function() {
            ...
            function save_results(response, status) {
                if (status != google.maps.DistanceMatrixStatus.OK) {
                    ...
                    if (response.rows[0].elements[0].status === "ZERO_RESULTS") {
                        $('#result')("Sorry , not available to use this travel mode between " + origin + " and " + destination);
                    } else {
            ...
            function appendResults(distance_in_kilo, distance_in_mile, duration_text) {
                ...
                $('#in_mile')(distance_in_mile.toFixed(2) + " MI");
                $('#price')(tota_price + "Rs");
            ...
            function ajaxShipmentCost() {
                ...
                var request_data = {
                    _token: 'Bc4iyDMhvZjJLXs1Q32PgfczTgOl5JnimEgHAAyg',
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            var path = window.location.pathname.split("index").pop();
